...
<template>
  <div class="page-content">
    ...
    <div class="header">
      ...
      <span>
        In compliance with DATA Privacy Act of 2012(RA 1073), I hereby allow Mater Dei
        College, Tubigon, Bohol to collect and process my personal information in relation
        to my job.
      </span>
