<template>
    <div class="personal-details-items">
        <div class="title-container">
            <span class="title">RESEARCH STUDIES, RESEARCH PROJECTS AND BOOK PUBLISHED FORM</span>
        </div>
