...
<template>
  ...
  <div class="personal-details-items" v-if="editMode == false">
    <div class="title-container">
      <span class="title">ACADEMIC AWARDS, HONORS, HONORARY DEGREE RECIEVED</span>
    </div>
    <div
    ...
    >
      ...
      <span>
        {{ userAward.date_received }} || {{ userAward.recognition_place }} ||
        {{ userAward.awarded_by }}
      </span>
    </div>
  </div>
...
export default {
  ...
  watch: {
    personalDetails: {
      handler(newVal) {
        this.userDetails.user_award_receives = newVal.user_award_receives || [];
      },
      immediate: true,
    },
  },
