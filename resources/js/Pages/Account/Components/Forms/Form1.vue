<template>
  ...
  <div class="personal-details-items" v-if="editMode == false">
    ...
    <div class="form-group">
      ...
      <span>
        {{ personalDetails.personal_details.residential_address.house_no }},
        ...
        {{ personalDetails.personal_details.residential_address.province }},
        {{ personalDetails.personal_details.residential_address.zip_code }}
      </span>
      ...
      <span>
        ...
        {{ personalDetails.personal_details.permanent_address.municipality }},
  ...
  <div class="personal-details-items" v-if="editMode == false">
    ...
    <ul v-for="jobDetail in personalDetails.user_job_details" :key="jobDetail">
  ...
  watch: {
    personalDetails: {
      handler(newVal) {
        ...
        this.userDetails.name_ext = newVal.personal_details.name_ext || "";
        this.userDetails.nickname = newVal.personal_details.nickname || "";
        this.userDetails.DOB = newVal.personal_details.DOB || "";
        this.userDetails.birthplace = newVal.personal_details.birthplace || "";
        this.userDetails.sex = newVal.personal_details.sex || "";
        this.userDetails.civil_status = newVal.personal_details.civil_status || "";
        this.userDetails.religion = newVal.personal_details.religion || "";
        this.userDetails.height = newVal.personal_details.height || "";
        this.userDetails.weight = newVal.personal_details.weight || "";
        this.userDetails.blood_type = newVal.personal_details.blood_type || "";
        this.userDetails.contact_no = newVal.personal_details.contact_no || "";
        this.userDetails.citizenship = newVal.personal_details.citizenship || "";
        ...
        this.userDetails.fb_link = newVal.personal_details.fb_link || "";

        this.userDetails.user_job_details = newVal.user_job_details || "";
      },
      immediate: true,
    },
  },
