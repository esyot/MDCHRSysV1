<template>
    <div class="personal-details-items" v-if="editMode">
        <div class="title-container">
            <span class="title"
                >RESEARCH STUDIES, RESEARCH PROJECTS AND BOOK PUBLISHED
                FORM</span
            >
        </div>
        ...
        >
            ...
            <button
                v-if="
                    userStud.date_published == '' &&
                    userStud.research_title == '' &&
                    userStud.journal_name == '' &&
                    userStud.link == ''
                "
    ...
    <div class="personal-details-items" v-if="editMode == false">
        <div class="title-container">
            <span class="title"
                >RESEARCH STUDIES, RESEARCH PROJECTS AND BOOK PUBLISHED</span
            >
        </div>
        <div
...
export default {
    ...
    methods: {
        ...
        removeField(index) {
            this.userDetails.user_studies.splice(index, 1);
        },
    },
    watch: {
        personalDetails: {
