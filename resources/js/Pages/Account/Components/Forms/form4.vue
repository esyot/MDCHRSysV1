<template>
    ...
    <div class="personal-details-items">
        <div class="title-container">
            <span class="title">PROFESSIONAL GOVERNMENT PASSED/CIVIL SERVICE ELIGIBILITY</span>
        </div>
    </div>
