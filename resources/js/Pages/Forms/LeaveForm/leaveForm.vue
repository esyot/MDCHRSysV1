<template>
    ...
    <div class="forms">
        ...
        <div class="form-details">
            <label for="departments">OFFICE/DEPARTMENT</label>
            <select name="departments" id="departments" class="forms-controller">
        ...
        <div class="form-details">
            ...
            <input
                ...
                id="middle_name"
                class="forms-controller"
                placeholder="eg., Seguirel"
            />
        </div>
        <div class="form-details">
            <label for="date_filed">DATE OF FILING:</label>
            <input
                type="date"
                id="date_filed"
                class="forms-controller"
    ...
    <div class="forms">
        ...
        <div class="form-details" v-show="leave_type === 'VACATION'">
            <label for="leave_type_vacation">In case of Vacation Leave:</label>
            <select
            id="leave_type_vacation"
            v-model="leave_vacation">
                <option value="Within the Philippines">Within the Philippines</option>
                <option value="Abroad">Abroad</option>
            </select>
        </div>
        <div class="form-details" v-show="leave_vacation === 'Within the Philippines'">
            <label for="leave_vacation_phil">If within the Philippines, please specify:</label>
            <input
            type="text"
        ...
        <div class="form-details" v-show="leave_vacation === 'Abroad'">
        ...
        <div class="form-details" v-show="leave_type === 'SICK'">
