...
<body>
    <div class="form-container">
        ...
        <div class="section">
            <div class="input-group">
                <label>Office/Department:
                    <span>{{ $office ?? 'CAST' }}</span>
                </label>
                <label>Last Name:
                    <span>{{ $last_name ?? 'Langoy' }}</span>
                </label>
                <label>First Name:
                    <span>{{ $first_name ?? 'John' }}</span>
                </label>
                <label>Middle Name:
                    <span>{{ $middle_name ?? 'Meward' }}</span>
                </label>
            </div>
        </div>
        <div class="ssection">
            <div class="iinput-group">
                <label>Date of Filing:
                    <span>{{ $date_of_filing ?? 'Feb 69, 2024' }}</span>
                </label>
                <label>Position:
                    <span>{{ $position ?? 'Dog style' }}</span>
                </label>
                <label>Rank:
                    <span>{{ $rank ?? 'Mythic' }}</span>
                </label>
            </div>
        </div>
        ...
        <div class="travel-section">
            <div class="travel-group">
                <div>
                    ...
                    <span>{{ $dates_of_travel ?? 'January 010, 2025' }}</span>
                </div>
                <div>
                    <label>Place:</label>
                    <span>{{ $place ?? 'Isla Kanto Pangi' }}</span>
                </div>
                <div>
                    <label>Purpose/Event:</label>
                    <span>{{ $purpose_event ?? 'Mamaje' }}</span>
                </div>
                <div>
                    <label>Organizer/Contact Person:</label>
                    <span>{{ $organizer ?? 'Meward Langoy' }}</span>
                </div>
                <div class="full-width">
                    <label>Short Description:</label>
                    <div class="description">{{ $description ?? 'Replace the input fields and textarea with dynamic data using Blade syntax.Here is the updated structure:' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="budget-section">
            <div class="left-side">
                <div class="mb-2">
                    <input type="checkbox" id="registration" name="budget_requirement" value="registration">
                    <label for="registration">Registration</label>
                </div>
                <div class="mb-2">
                    <input type="checkbox" id="transportation" name="budget_requirement" value="transportation">
                    <label for="transportation">Transportation</label>
                </div>
                <div class="mb-2">
                    <input type="checkbox" id="representation" name="budget_requirement" value="representation">
                    <label for="representation">Representation Allowance</label>
                </div>
                <div>
                    <input type="checkbox" id="miscellaneous" name="budget_requirement" value="miscellaneous">
            ...
            <div class="right-side">
                <div>
                    ...
                    <div class="mb-2">
                        <input type="checkbox" id="departmental-fund" name="budget_charged" value="departmental-fund">
                        <label for="departmental-fund">Departmental Fund</label>
                    </div>
                    <div class="mb-2">
                        <input type="checkbox" id="departmental-office-budget" name="budget_charged" value="departmental-office-budget">
                        <label for="departmental-office-budget">Departmental/Office Budget</label>
                    </div>
                    <div class="mb-2">
                        <input type="checkbox" id="school-fund" name="budget_charged" value="school-fund">
                        <label for="school-fund">School Fund</label>
                    </div>
                    <div>
                        <input type="checkbox" id="others" name="budget_charged" value="others">
                        <label for="others">Others,specify</label> <input type="text" class="others">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="note">
            <label for="">Note: This form should be submitted in duplicate copy at least 10 days in advance.</label>
        </div>
    </div>
    </div>
</body>
